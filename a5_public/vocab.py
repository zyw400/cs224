...
class VocabEntry(object):
    ...
    def __init__(self, word2id=None):
        ...
        # print(self.char2id)
        # import json
        # with open('vocab_char_yw.json', 'w') as fp:
        #     json.dump(self.char2id, fp)
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        word_id = self.words2charindices(sents)
        word_id_padded = pad_sents_char(word_id, self.char_pad)
        sents_var = torch.tensor(word_id_padded, dtype=torch.long, device=device)
        
        # crucial change here, the version below has bad performance
        # sents_var = sents_var.view(sents_var.size()[1], sents_var.size()[0], sents_var.size()[2])
    ...
    def to_input_tensor(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        # print("sents_var")
        # print("max_sentence_length: {}".format(sents_var.size()))
